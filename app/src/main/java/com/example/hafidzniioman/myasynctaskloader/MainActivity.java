package com.example.hafidzniioman.myasynctaskloader;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<WeatherItems>> {
    ...
    static final String EXTRAS_CITY = "EXTRAS_CITY";
        ...
        (Loader < ArrayList < WeatherItems >> loader, ArrayList < WeatherItems > data){
        ...
        View.OnClickListener myListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = new Bundle();
                bundle.putString(EXTRAS_CITY, kota);
                getLoaderManager().restartLoader(0, bundle, (android.app.LoaderManager.LoaderCallbacks<Object>) MainActivity.this);
            }
        };
    }
